...
export const metadata: Metadata = {
    title: 'Mapy kompetencji Gallup dla zespołów | Finarena',
    description: 'Poznaj mapy kompetencji Gallup dla zespołów i zwiększ produktywność. Zbuduj silniejszą współpracę wykorzystując badania talentów.',
};
