...
export const sectors: Sector[] = [
  {
    ...
    cases: [
      { name: 'Motolia', desc: 'Platforma dla rynku motoryzacyjnego — automatyzacja obsługi ofert i danych pojazdów.', tags: ['Next.js', 'AI extraction', 'Integracje'] },
  ...
  },
  {
    ...
    problem:
      'Praca powtarzalna — czytanie, klasyfikowanie, porównywanie dokumentów — zjada godziny najdroższych ludzi w organizacji. Ryzyko rośnie razem z liczbą spraw.',
    approach: [
    ...
    cases: [
      { name: 'Votenti', desc: 'Cyfrowe głosowania i procesy decyzyjne — bezpieczeństwo i audytowalność.', tags: ['Security', 'Workflow', 'e-Voting'] },
